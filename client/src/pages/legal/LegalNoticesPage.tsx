  ...
  return (
    <div className="flex flex-col gap-8 mb-24">
      ...
      <div className="flex flex-col gap-4">
        <h2 className="font-bold text-xl">Définitions</h2>
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> met à
        ...
        <p>
          ...
          d’être détenues par{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> pour la
        ...
        <div className="flex flex-col gap-4">
          ...
          <p>
            ...
            <a href="https://monflami.fr/">https://monflami.fr/</a> l'identité
          ...
          <p>
            ...
            morale.
            <br />
            <strong>Webmaster</strong> : Martin Théo – support@monflami.fr
            <br />
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> implique
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> sont donc
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a>, qui
          s’efforcera alors de communiquer préalablement aux utilisateurs les
          dates et heures de l’intervention. Le site web{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> est mis à jour
          régulièrement par{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> responsable.
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          Le site internet{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> a pour objet
          de fournir une information concernant l’ensemble des activités de la
          société. <a href="https://monflami.fr/">https://monflami.fr/</a>{" "}
          s’efforce de fournir sur le site{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> des
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> sont données à
          titre indicatif, et sont susceptibles d’évoluer. Par ailleurs, les
          renseignements figurant sur le site{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> ne sont pas
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> est hébergé
        ...
        <p>
          {" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> et l’hébergeur
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          {" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> est
          ...
          préalable de : <a href="https://monflami.fr/">https://monflami.fr/</a>
          .
        </p>
        <p>
      ...
      <div className="flex flex-col gap-4">
        <h2 className="font-bold text-xl">6. Limitations de responsabilité.</h2>
        <p>
          {" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> agit en tant
          qu’éditeur du site.{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> est
        ...
        <p>
          {" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> ne pourra
          ...
          l’utilisation du site{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a>. Des espaces
          interactifs (possibilité de poser des questions dans l’espace contact)
          sont à la disposition des utilisateurs.{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> se réserve le
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> se réserve
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          le responsable du traitement des Données Personnelles est : Martin
          Théo. <a href="https://monflami.fr/">https://monflami.fr/</a> est
          représenté par Théo Martin, son représentant légal
        </p>
        <p>
          En tant que responsable du traitement des données qu’il collecte,{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> s’engage à
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> traite des
          Données Personnelles,{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> prend toutes
          ...
          lesquelles <a href="https://monflami.fr/">https://monflami.fr/</a> les
          traite.
        </p>
        ...
        <ul>
          ...
          <li>
            ...
            <a href="https://monflami.fr/">https://monflami.fr/</a> : adresse
            email
          </li>
          <li>
        ...
        <p>
          {" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> ne
        ...
        <p>
          ...
          Utilisateurs de{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> disposent des
          droits suivants :
        </p>
        <ul>
          <li>
          ...
          <li>
            ...
            <a href="https://monflami.fr/">https://monflami.fr/</a> devra
            communiquer (ou non) ses données à un tiers qu’ils aura
            préalablement désigné
          </li>
        </ul>
        <p>
          Dès que <a href="https://monflami.fr/">https://monflami.fr/</a> a
          connaissance du décès d’un Utilisateur et à défaut d’instructions de
          sa part, <a href="https://monflami.fr/">https://monflami.fr/</a>{" "}
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> utilise ses
          Données Personnelles, demander à les rectifier ou s’oppose à leur
          traitement, l’Utilisateur peut contacter{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> par écrit à
          l’adresse suivante :
        </p>
        support@monflami.fr
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> corrige, mette
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> par la loi,
          notamment en matière de conservation ou d’archivage des documents.
          Enfin, les Utilisateurs de{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> peuvent
        ...
        <p>
          {" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> s’interdit de
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> reste libre du
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> sont
          principalement les agents de notre service client.
        </p>
        <div ng-bind-html="rgpdHTML"></div>
      </div>
      <div className="flex flex-col gap-4">
        <h2 className="font-bold text-xl">8. Notification d’incident</h2>
        <p>
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> n'est publiée
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> et de ses
          ...
          du site <a href="https://monflami.fr/">https://monflami.fr/</a>.
        </p>
        <h3>Sécurité</h3>
        <p>
          Pour assurer la sécurité et la confidentialité des Données
          Personnelles et des Données Personnelles de Santé,{" "}
          <a href="https://monflami.fr/">https://monflami.fr/</a> utilise des
      ...
      <div className="flex flex-col gap-4">
        ...
        <p>
          ...
          <a href="https://monflami.fr/">https://monflami.fr/</a> est soumis au
