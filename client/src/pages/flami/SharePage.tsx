...
const SharePage = () => {
  ...
  <div className="flex flex-col gap-8">
    ...
    <div className="flex flex-col gap-8">
        <img style={{filter: "drop-shadow(0px 0px 43px #ff900047)"}} className="max-h-80 w-auto m-auto-v" src="/assets/img/animations/IdleAnim.gif" alt="" />
            ...
            <div className="flex flex-col gap-1 w-2/3 text-alabaster-50">
                {
                  flami?.shared_flami ? (
                    <>
                      ...
                      <span className="text-2xl text-tree-poppy-500">{flami?.owner}</span>
                    </>
                  ) : (
                    <div>
        ...
        <div className="flex">
        <Button variant={"primary"} type="button" onClick={() => navigate("/share/scan")}>
